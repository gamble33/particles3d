...
public class CollisionHandler : MonoBehaviour
{
    ...
    public void SetParticlesResultantVelocities(Particle particle, Particle collided, Vector3 pVelocity, float pMass = 1f)
    {
    ...
    /// <returns></returns>
    private Vector2 CalculateVelocities(float particle1Mass, float particle2Mass, float particle1Velocity, float particle2Velocity)
    {
        float velocityParticle1 = ((particle1Mass - particle2Mass) / (particle1Mass + particle2Mass)) * particle1Velocity + ((2*particle2Mass)/(particle1Mass + particle2Mass)) * particle2Velocity;
